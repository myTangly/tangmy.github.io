...
当前为 design/glass-home 本地预览，未覆盖线上 master。主站替换须等待用户视觉确认及两个作品 HTTPS 实际访问通过。未核验的项目以不可点击状态显示，data-target 保存未来地址；启用时使用 target="_blank"、rel="noopener noreferrer" 并添加“新标签页打开”说明。
